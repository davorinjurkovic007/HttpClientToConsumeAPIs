...
{
    public class DealingWithErrorAndFaultsService : IIntegrationService
    {
        private readonly IHttpClientFactory httpClientFactory;
        private CancellationTokenSource cancellationTokenSource = new CancellationTokenSource();

        public DealingWithErrorAndFaultsService(IHttpClientFactory httpClientFactory)
        {
        ...
        public async Task Run()
        {
            ...
            await PostMovieAndHandleValidatioErrors(cancellationTokenSource.Token);
        }
        ...
        private async Task PostMovieAndHandleValidatioErrors(CancellationToken cancellationToken)
        {
            var httpClient = httpClientFactory.CreateClient("MoviesClient");
